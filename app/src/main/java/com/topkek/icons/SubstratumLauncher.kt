...
import com.topkek.icons.ThemerConstants.APK_SIGNATURE_PRODUCTION
import com.topkek.icons.ThemerConstants.BASE_64_LICENSE_KEY
import com.topkek.icons.ThemerConstants.ENABLE_KNOWN_THIRD_PARTY_THEME_MANAGERS
import com.topkek.icons.ThemerConstants.ENFORCE_AMAZON_APP_STORE_INSTALL
import com.topkek.icons.ThemerConstants.ENFORCE_GOOGLE_PLAY_INSTALL
import com.topkek.icons.ThemerConstants.ENFORCE_INTERNET_CHECK
import com.topkek.icons.ThemerConstants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION
import com.topkek.icons.ThemerConstants.MINIMUM_SUBSTRATUM_VERSION
import com.topkek.icons.ThemerConstants.PIRACY_CHECK
import com.topkek.icons.ThemerConstants.SUBSTRATUM_FILTER_CHECK
import com.topkek.icons.ThemerConstants.THEME_READY_GOOGLE_APPS
import com.topkek.icons.internal.SystemInformation.SUBSTRATUM_PACKAGE_NAME
import com.topkek.icons.internal.SystemInformation.checkNetworkConnection
import com.topkek.icons.internal.SystemInformation.getSelfSignature
import com.topkek.icons.internal.SystemInformation.getSelfVerifiedIntentResponse
import com.topkek.icons.internal.SystemInformation.getSelfVerifiedPirateTools
import com.topkek.icons.internal.SystemInformation.getSelfVerifiedThemeEngines
import com.topkek.icons.internal.SystemInformation.getSubstratumUpdatedResponse
import com.topkek.icons.internal.SystemInformation.hasOtherThemeSystem
import com.topkek.icons.internal.SystemInformation.isCallingPackageAllowed
import com.topkek.icons.internal.SystemInformation.isPackageInstalled
import com.topkek.icons.internal.TBOConstants.THEME_READY_PACKAGES
import java.io.File
import java.util.*
